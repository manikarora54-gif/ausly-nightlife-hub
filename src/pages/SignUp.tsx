            ...
            <div className="glass-card p-6 md:p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button 
                  ...
                  className="w-full"
                  onClick={() => {
                    alert('Google sign-up would be implemented here. In production, this would integrate with Google OAuth.');
                  }}
                >
                ...
                <Button 
                  ...
                  className="w-full"
                  onClick={() => {
                    alert('GitHub sign-up would be implemented here. In production, this would integrate with GitHub OAuth.');
                  }}
                >
