...
const WhatsHappeningSection = ({ selectedCity }: WhatsHappeningSectionProps) => {
  ...
  const happeningNow = [
    ...events.map((event: any) => ({
      ...
      image: event.images?.[0] || getFallbackImage("event", event.name?.length || 0),
  ...
  return (
    <section ref={ref} className="py-20 relative overflow-hidden">
      ...
      {/* Decorative glow */}
      <GlowOrb color="primary" size={250} className="top-[10%] right-[5%]" />
      <GlowOrb color="secondary" size={200} className="bottom-[10%] left-[5%]" />
